...
/**
 * Iways PaypalInstalments Adminhtml Sales Order Totals
 *
 * @category   Iways
 * @package    Iways_PaypalInstalments
 * @author robert
 */
class Iways_PaypalInstalments_Block_Adminhtml_Sales_Order_Totals
    extends Mage_Adminhtml_Block_Sales_Order_Totals
{
    /**
     * Add instalment fee amt to order totals
     */
    protected function _initTotals()
    {
        parent::_initTotals();
        if (((float)$this->getSource()->getInstalmentsFeeAmt()) != 0) {
