 ...
 */
class Mediotype_Ticket_Block_Adminhtml_Reports_Print_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl("*/*/printTickets", array('ticket_ids' => $row->getId()));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem(
            'print_documents',
            array(
                'label' => $this->__('Print Tickets'),
                'url' => $this->getUrl('*/*/printTickets'),
            )
        );
