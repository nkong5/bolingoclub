...
class Meigee_ThemeOptionsUnique_Block_Adminhtml_System_Config_Form_Field_Font extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        googleFontPreviewModel.prototype = {
            initialize : function()
            {
				if($("meigee_unique_design_appearance_gfontmain")){
					this.fontElement = $("meigee_unique_design_appearance_gfontmain");
				} else if($("meigee_unique_design_skin1_appearance_gfontmain")) {
					this.fontElement = $("meigee_unique_design_skin1_appearance_gfontmain");
				} else if($("meigee_unique_design_skin2_appearance_gfontmain")) {
					this.fontElement = $("meigee_unique_design_skin2_appearance_gfontmain");
				} else if($("meigee_unique_design_skin3_appearance_gfontmain")) {
					this.fontElement = $("meigee_unique_design_skin3_appearance_gfontmain");
				} else if($("meigee_unique_design_skin4_appearance_gfontmain")) {
					this.fontElement = $("meigee_unique_design_skin4_appearance_gfontmain");
				}
