document.observe('dom:loaded', function(){
	...
	var targetOrigin = getDomainFromUrl($('hcdcc_payment_frame').readAttribute('src'));
	
	// ### Sending postMessages ###
	
	
	
	var paymentFrameForm = $('paymentFrameForm');
	var paymentFrameIframe = $('hcdcc_payment_frame');
